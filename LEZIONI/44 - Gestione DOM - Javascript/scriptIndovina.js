...
// Tempo rimanente
var tempoRimanente = tempoMassimo; // alinizio è uguale al tempo massimo
...
if (valoreTentativo === numeroMisterioso) {
    ...
    document.getElementById("risultato").innerHTML = "Hai indovinato il numero in " +
    numTentativi + " tentativi!";
    ...
    document.getElementById("risultato").innerHTML = messaggioRisultato +
    iconaRisultato;
    }
